<%@ Page Title="PRODUCT-CATEGORY" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <br />
            <div>
                <asp:GridView ID="gvProductCategory" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                    DataKeyNames="CategoryID" GridLines="None" AutoGenerateColumns="False" AllowPaging="True"
                    OnRowDeleting="gvProductCategory_RowDeleting" HeaderStyle-HorizontalAlign="Left">
                ...
                <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Style="display: none">
                    <table width="100%" style="border: Solid 3px #3D73B1; width: 100%;" cellpadding="5px"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtEditProductCategory" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
