<%@ Page Title="PRODUCT-SUB-CATEGORY" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="ProductSubcategory.aspx.cs" Inherits="Rupa.MasterEntry.ProductSubcategory" %>
        ...
        <ContentTemplate>
            ...
            <div align="center">
                <table style="width: 70%;" class="tbl_style">
                    <tr>
                        <td colspan="4" class="tbl_Header">Add New SubCategory
                        </td>
                    </tr>
                    <tr>
                        <td align="left">Sub Category Name
                        </td>
                        <td align="left">:
                        </td>
                        <td align="left">
            ...
            <br />
            <div>
                <asp:GridView ID="gvSubCategory" runat="server" CellPadding="4" 
                    ForeColor="#333333" Width="100%"  
                    DataKeyNames="SubCategoryID" GridLines="None" AutoGenerateColumns="False" AllowPaging="True"
                    OnRowDeleting="gvSubCategory_RowDeleting" onpageindexchanging="gvSubCategory_PageIndexChanging" 
                    >
                    ...
                    <table width="100%" style="border: Solid 3px #3D73B1; width: 100%;" cellpadding="5px"
                        ...
                        <tr class="popUpheader">
                            <td colspan="2" style="height: 10%; color: White; font-weight: bold; font-size: larger"
                                align="center">Update Brand
                            </td>
                        </tr>
                        <tr>
                            <td align="left">Sub Category ID :
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtEditProductSubCategory" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
