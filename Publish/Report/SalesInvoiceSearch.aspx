<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="SalesInvoiceSearch.aspx.cs" Inherits="Rupa.Report.SalesInvoiceSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <div align="center">
        <asp:GridView ID="gvSalesInvoice" runat="server" CellPadding="4" Width="50%" EmptyDataText="No Data Found"
            ShowHeader="true" DataKeyNames="SalesInvoiceMasterID" AutoGenerateColumns="False"
            BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px"
            AllowPaging="True" OnPageIndexChanging="gvSalesInvoice_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Tax Invoice No">
                    <ItemTemplate>
                        <a href='<%#"SalesInvoicePrint.aspx?pID="+DataBinder.Eval(Container.DataItem,"SalesInvoiceMasterID") %>'>
                            <%#Eval("SalesInvoiceMasterID")%>
                        </a>
                    </ItemTemplate>
                </asp:TemplateField>
