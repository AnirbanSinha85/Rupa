<%@ Page Title="SUPPLIER" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="Supplier.aspx.cs" Inherits="Rupa.MasterEntry.Supplier" %>
        ...
        <ContentTemplate>
            ...
            <div>
                <asp:GridView ID="gvSupplier" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                    DataKeyNames="SupplierID" GridLines="None" AutoGenerateColumns="False" AllowPaging="True"
                    OnRowDeleting="gvSupplier_RowDeleting" HeaderStyle-HorizontalAlign="Left">
